...
class AddDefaultSources(Task):
    ...
    @classmethod
    def run(cls, info):
        from bootstrapvz.common.releases import sid, wheezy, kali_rolling
        ...
        if info.manifest.release != sid and info.manifest.release != kali_rolling and info.manifest.release >= wheezy:
